<div class="bg-light py-3">
  <div class="container">
    <div class="row">
      <div class="col-md-12 mb-0"><a href="<?php echo base_url() ?>home">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Obat</strong></div>
    </div>
  </div>
</div>
...
<div class="py-5">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <h2 class="h3 mb-5 text-black">Daftar Obat</h2>
      </div>
    ...
    <div class="row">
      ...
      ?>
        ...
        <div class="col-sm-6 col-lg-4 text-center item mb-4 item-v2">
          <a href="<?php echo base_url() ?>product/detail?id=<?php echo $u->id ?>"> <img width="250" height="300" src="<?php echo base_url() ?>asset/obat/<?php echo $u->gambar ?>" alt="Image"></a>
